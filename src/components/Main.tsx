...
export default function Main() {
  ...
  const [FINISH_NODE_ROW, setFINISH_NODE_ROW] = React.useState(17);
  ...
  const [MOBILE_ROW_COUNT, setMOBILE_ROW_COUNT] = React.useState(20);
  const [MOBILE_COLUMN_COUNT, setMOBILE_COLUMN_COUNT] = React.useState(20);
